...
?>
    ...
    <section class="banner_area" data-stellar-background-ratio="0.5">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#" >License and Registration</a></li>
        </ol>
    </section>
    <!-- End Banner area -->
        ...
        <div class="container">
            <div class="row about_row about_us2_pages">
                <div class="who_we_area col-md-7">
                    <div class="subtittle">
                        <h2 style="font-size: 36px;">License and Registration</h2>
                    </div>
                    <p>PSARA License is a prerequisite before any person starts a private security business in India.The application for license to start a private security agency is made to the competent authority if the state. The PSARA License is issued to operate in one or more district of a particular state or for the entire state.<br><br>
                     PSARA Act is the regulatory act for keeping an eye on the private security agencies operating in India. All the private security agencies need to have this PSARA License before starting their service. </p>
                    <!-- <a href="#" class="button_all">Contact Now</a> -->
                </div>
                <div class="col-md-5 our_skill_inner">
                    <img src="images/choose.jpg" alt="" height="300px" width="400px">
