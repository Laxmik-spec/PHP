...
<head>
	...
	<meta name="robots" content="" />
		...
		<!-- DESCRIPTION -->
		<meta name="description" content="Renuka Foundation Group of Institute" />
	
	<!-- OG -->
	<meta property="og:title" content="Renuka Foundation Group of Institute" />
	<meta property="og:description" content="Renuka Foundation Group of Institute" />
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>Renuka Foundation Group of Institute</title>
...
<div id="loading-icon-bx"></div>
				...
				<div id="rev_slider_486_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.3.0.2">
					<ul>	<!-- SLIDE  -->
						...
						data-description="Science says that Women are generally happier">
							<!-- MAIN IMAGE -->
							<img src="assets/images/main/slider.jpg" alt="" 
							...
							<div class="tp-caption tp-shape tp-shapewrapper " 
								...
								data-responsive="off"
								data-frames='[{"from":"opacity:5;","speed":1,"to":"o:1;","delay":0,"ease":"Power4.easeOut"},{"delay":"wait","speed":1,"to":"opacity:5;","ease":"Power4.easeOut"}]'
								data-textAlign="['left','left','left','left']"
								data-paddingtop="[0,0,0,0]"
								data-paddingright="[0,0,0,0]"
								data-paddingbottom="[0,0,0,0]"
								data-paddingleft="[0,0,0,0]"
								style="z-index: 5;background-color:rgba(2, 0, 11, 0.50);border-color:rgba(0, 0, 0, 0);border-width:0px;"> </div>	
							<!-- LAYER NR. 2 -->
							<div class="tp-caption Newspaper-Title   tp-resizeme" 
								...
								style="z-index: 6; font-family:rubik; font-weight:700; text-align:center; white-space: normal;">
									Welcome To <br>Renuka Foundation <br>Group Of Institute <br>Kallam
							</div>
					...
					<!-- 		<div class="tp-caption tp-shape tp-shapewrapper " 
						...
						<!-- 	<div class="tp-caption Newspaper-Title   tp-resizeme" 
								...
								style="z-index: 6; font-family:rubik; font-weight:700; text-align:center; white-space: normal;text-transform:uppercase;">
									Welcome To <br>Renuka Group of Foundation
							</div> -->
						...
						<div class="col-lg-6 col-md-6 col-sm-6">
							<div class="service-bx">
								...
								<div class="info-bx text-center">
									...
									<h5 class="text-uppercase bg"><a href="#"><font color="#f7b205">Upcoming Building Plan </font><br> Renuka Foundation Group of Institute</a></h5>
						...
						<div class="col-lg-6 col-md-6 col-sm-6">
							<div class="service-bx">
								...
								<div class="info-bx text-center">
									...
									<h5 class="text-uppercase bg"><a href="#"><font color="#f7b205">Upcoming Education Plan </font><br> Renuka Foundation Group of Institute</a></h5>
 ...
 <!-- Our Story ==== -->
 <div class="section-area bg-gray section-sp1 our-story mb-4 ">
				<div class="container ">
					<div class="row align-items-center d-flex">
						...
						<div class="col-lg-8 col-md-12 heading-bx ">
							...
							Renuka Foundation Group of Institute Kallam या संस्थेची स्थापना सन जून २००७ रोजी संस्थापक जाधवर शरद यांनी कळंब या ठिकाणी केली.संस्थेची स्थापना झाली त्या वर्षी २/३ कोर्स होते त्याचे रुपांतर आज मोठया वटवृक्षात होऊन आजच्या वर्षी संस्थेत ३५ कोर्स चालु आहेत आणि येणाऱ्या काळात या संस्थेमध्ये D.Pharm., B.Pharm., Medical Picot a Renuka Podar International English School चालू करायचे ध्येय आहे.
							</p>
			...
			<!-- Popular Courses -->
			<div class="section-area section-sp2 popular-courses-bx p-5">
                <div class="container">
					<div class="row">
						<div class="col-md-12 heading-bx left">
							<h2 class="title-head">ALL <span>Courses - Renuka Foundation Group of Institute Kallam</span></h2>
					...
					<div class="courses-carousel owl-carousel owl-btn-1 col-12 p-lr0">
						<!-- <div class="item">
							<div class="cours-bx">
								...
								<div class="info-bx text-center">
									<h5><a href="#">Renuka Group Of Foundation</a></h5>
									<span>Courses</span>
								</div>
						...
						<div class="item">
							<div class="cours-bx">
								<div class="action-box">
									<img src="assets/images/photos/nursing/nursing 1.jpeg" alt="">
									<a href="renuka-nursing.php" class="btn">Read More</a>
								</div>
								<div class="info-bx text-center">
									<h5><a href="renuka-nursing.php">Renuka Nursing <br>College</a></h5>
									<span>Courses</span>
								</div>
								<!-- <div class="cours-more-info">
									<div class="review">
						...
						<div class="item">
							<div class="cours-bx">
								<div class="action-box">
									<img src="assets/images/photos/paramedic/paramedic 1.jpeg" alt="">
									<a href="renuka-paramedical.php" class="btn">Read More</a>
								</div>
								<div class="info-bx text-center">
									<h5><a href="renuka-paramedical.php">Renuka Paramedical Institute</a></h5>
									<span>Courses</span>
								</div>
								<!-- <div class="cours-more-info">
									<div class="review">
						...
						<div class="item">
							<div class="cours-bx">
								<div class="action-box">
									<img src="assets/images/photos/class/class 1.jpeg" alt="">
									<a href="renuka-vocational.php" class="btn">Read More</a>
								</div>
								<div class="info-bx text-center">
									<h5><a href="renuka-vocational.php">Renuka Vocational Training Institute</a></h5>
									<span>Courses</span>
								</div>
								<!-- <div class="cours-more-info">
									<div class="review">
						...
						<div class="item">
							<div class="cours-bx">
								<div class="action-box">
									<img src="assets/images/photos/class/class 19.jpeg" alt="">
									<a href="renuka-management.php" class="btn">Read More</a>
								</div>
								<div class="info-bx text-center">
									<h5><a href="renuka-management.php">Renuka Management Institute</a></h5>
									<span>Courses</span>
								</div>
								<!-- <div class="cours-more-info">
									<div class="review">
						...
						<div class="item">
							<div class="cours-bx">
								<div class="action-box">
									<img src="assets/images/photos/distance.jpeg" alt="">
									<a href="renuka-distance.php" class="btn">Read More</a>
								</div>
								<div class="info-bx text-center">
									<h5><a href="renuka-distance.php">Renuka Distance Education Institute</a></h5>
									<span>Courses</span>
								</div>
								<!-- <div class="cours-more-info">
									<div class="review">
						...
						<div class="item">
							<div class="cours-bx">
								<div class="action-box">
									<img src="assets/images/photos/class/class 8.jpeg" alt="">
									<a href="renuka-socialwork.php" class="btn">Read More</a>
								</div>
								<div class="info-bx text-center">
									<h5><a href="renuka-socialwork.php">Renuka Social Work Institute</a></h5>
									<span>Courses</span>
								</div>
								<!-- <div class="cours-more-info">
									<div class="review">
